...
/* harmony import */ var widok_scroll_item__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! widok-scroll-item */ "./node_modules/widok-scroll-item/widok-scroll-item.js");
...
var MIN_TIME_BETWEEN_PART_CHANGES = 500;
var MIN_TIME_BETWEEN_WHEEL_EVENTS = 100;
var SCROLL_PER_WHEEL_EVENT = 300;
...
function isPartBottomBelowScreenTop(part, delta) {
  return part.offset + part.height > widok__WEBPACK_IMPORTED_MODULE_1__.default.s - 10 * delta;
}

function isPartBottomAboveScreenBottom(part, delta) {
  return part.offset + part.height < widok__WEBPACK_IMPORTED_MODULE_1__.default.s + widok__WEBPACK_IMPORTED_MODULE_1__.default.h - 10 * delta;
}

function willPartBottomBeAboveScreenBottom(part) {
  return part.offset + part.height < widok__WEBPACK_IMPORTED_MODULE_1__.default.s + widok__WEBPACK_IMPORTED_MODULE_1__.default.h + SCROLL_PER_WHEEL_EVENT;
}

function willPartTopBeBelowScreenTop(part) {
  return part.offset > widok__WEBPACK_IMPORTED_MODULE_1__.default.s - SCROLL_PER_WHEEL_EVENT;
}
/**
...
var ScrollSnap = /*#__PURE__*/function () {
  function ScrollSnap(options) {
    var _this = this;

    _classCallCheck(this, ScrollSnap);

    this.parts = [];
    cash_dom__WEBPACK_IMPORTED_MODULE_0___default()(options.part).map(function (i, e) {
      return _this.parts.push((0,widok_scroll_item__WEBPACK_IMPORTED_MODULE_2__.default)(e));
    });
    this.wasPartScrolled = false;
    this.lastWheelEvent = 0;
    window.addEventListener('mousewheel', this.mouseWheelHandlerCaller.bind(this), {
      passive: false
    });
    window.addEventListener('DOMMouseScroll', this.mouseWheelHandlerCaller.bind(this), {
      passive: false
    });
  ...
  _createClass(ScrollSnap, [{
    key: "wasCalledRecently",
    value: function wasCalledRecently() {
      var now = new Date().getTime();
      var wasCalledRecently = this.lastWheelEvent + MIN_TIME_BETWEEN_WHEEL_EVENTS > now;
      this.lastWheelEvent = now;
      return wasCalledRecently;
    }
  }, {
    key: "preventDefaultScroll",
    value: function preventDefaultScroll(event) {
    ...
    key: "mouseWheelHandlerCaller",
    value: function mouseWheelHandlerCaller(event) {
      if (widok__WEBPACK_IMPORTED_MODULE_1__.default.w <= 900) return;
    ...
    value: function scrollToTarget(target) {
      ...
      if (delta > 0) target -= widok__WEBPACK_IMPORTED_MODULE_1__.default.h;
      window.scrollTo({
        top: target,
        behavior: 'smooth'
      });
      ...
      setTimeout(function () {
        _this2.wasPartScrolled = false;
      }, MIN_TIME_BETWEEN_PART_CHANGES);
    }
  }, {
    key: "preventOverscrolling",
    value: function preventOverscrolling(part, delta) {
      if (delta < 0 && willPartBottomBeAboveScreenBottom(part)) {
        this.scrollToTarget(part.offset + part.height - widok__WEBPACK_IMPORTED_MODULE_1__.default.h);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (createScrollSnap);
...
/* harmony import */ var _scroll_snap__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./../../../scroll-snap */ "./scroll-snap.js");


(0,_scroll_snap__WEBPACK_IMPORTED_MODULE_1__.default)({
  part: '.part'
});
})();
